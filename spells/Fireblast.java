...
/**
 * Clasa spell-ului Fireblast al Pyromancer-ului. Aceasta clasa se foloseste de Double Dispatch
...
public class Fireblast extends Spell {
    ...
    private static final int DAMAGE_BASE = 350;
    private static final int DAMAGE_PER_LEVEL = 50;

    public Fireblast(final Hero caster) {
        super(caster);
