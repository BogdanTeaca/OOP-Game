...
/**
 * Clasa spell-ului Slam al Knight-ului. Aceasta clasa se foloseste de Double Dispatch pentru
...
public class Slam extends Spell {
    ...
    private static final int DAMAGE_BASE = 100;
    private static final int DAMAGE_PER_LEVEL = 40;

    public Slam(final Hero caster) {
        super(caster);
    ...
    public void castSpell(final Hero opponent, final LandType landType) {
        ...
        opponent.addEffectOverTime(new SlamOverTime());
    }
